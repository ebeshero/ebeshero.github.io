    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>  
                ...
                <div id="content">
                    <h2><a id="top"/>Working Bibliography of Mary Russell Mitford&#8217;s Publications</h2>
                    ...
                    <h3>Sorted by Date of First Publication</h3>
                    ...
                    <h3>
                        <a href="bibliogType.html">View the bibliography sorted by type of publication</a>
                    </h3>
